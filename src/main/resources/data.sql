...
insert into tasks (title, description, finished) values ('task 1', 'desc 1', false);

insert into tags(name) values ('tag 1');

insert into billing_info (street, province, postal_code, country) values ('street 1', 'province 1', '10000', 'country1');
